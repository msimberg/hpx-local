...
#include <pika/init_runtime_local/init_runtime_local.hpp>
    ...
    defined(__FreeBSD__)
            ...
            void init_environment()
            {
                ...
                pika::set_custom_exception_info_handler(
                    &pika::local::detail::custom_exception_info);
                pika::serialization::detail::set_save_custom_exception_handler(
                    &pika::runtime_local::detail::save_custom_exception);
                pika::serialization::detail::set_load_custom_exception_handler(
                    &pika::runtime_local::detail::load_custom_exception);
                ...
                pika::detail::set_get_full_build_string(
                    &pika::local::full_build_string);
                ...
                int argc, char** argv, init_params const& params, bool blocking)
            {
                ...
                try
                {
                    ...
                    pika::local::detail::command_line_handling cmdline{
                ...
                {
                    std::cerr << "pika::local::init: std::exception caught: "
                              << e.what() << "\n";
                    return -1;
                }
                return result;
